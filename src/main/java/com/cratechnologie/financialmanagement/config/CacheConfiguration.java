package com.cratechnologie.financialmanagement.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.cratechnologie.financialmanagement.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.cratechnologie.financialmanagement.repository.UserRepository.USERS_BY_EMAIL_CACHE);
